      ...
      <nav class="site-nav">
        ...
        <ul class="site-nav__list">
          <li
            ...
            :key="navLink.title"
          >
            <nuxt-link class="site-nav__href" :to="navLink.url">
              {{ navLink.title }}
            </nuxt-link>
            <ul class="site-nav__submenu" v-if="navLink.sublinks">
              <li v-for="sublink in navLink.sublinks" :key="sublink.title">
                <nuxt-link :to="sublink.url">
                  {{ sublink.title }}
                </nuxt-link>
              </li>
            </ul>
